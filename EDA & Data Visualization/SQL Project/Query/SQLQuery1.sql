...
from [SQL_RFM_Analysis_Project].[dbo].[sales_data_sample]
...
----We see that the sales are very low in the year 2005, let's try to find out the reason behind the low sales
select distinct MONTH_ID from [dbo].[sales_data_sample]
where YEAR_ID = 2005
--- After observing the data, we get to know that the company operated only for 5 months in the year 2005 resulting in low sales.
...
---Let's try to find out what was the best month for sales in a specific year? How much was earned that month?
...
---November seems to be the best month, let's see what product do they sell in the month of November
...
---Let's see who our best customer is. This can be answered with RFM (Recency-Frequency-Monetary)
